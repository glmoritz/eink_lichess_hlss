...
class LichessAccount(Base):
    ...
    api_token: Mapped[str] = mapped_column(Text, nullable=False)  # Should be encrypted in production
...
class Game(Base):
    ...
    account_id: Mapped[str] = mapped_column(String(36), ForeignKey("lichess_accounts.id"))
